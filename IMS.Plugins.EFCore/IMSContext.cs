    ...
    public class IMSContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductInventory>()
                ...
                .WithMany(i => i.PoductInventories)
            ...
            modelBuilder.Entity<Inventory>().HasData(
                ...
                new Inventory { InventoryId=5,InventoryName="Electric Engine", Price=4000,Quantity=2},
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product { ProductId = 1, ProductName = "Gas Car", Price = 20000, Quantity = 4 },
                new Product { ProductId = 2, ProductName = "Electric Car", Price = 15000, Quantity = 2 }
                );
